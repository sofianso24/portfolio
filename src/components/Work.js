              ...
              <div className='container mx-auto'>
                 <div className='flex flex-col lg:flex-row gap-x-10'>
                    ...
                    className='flex-1 flex flex-col gap-y-12 mb-10 lg:mb-0'>
                       {/*text*/}
                         <div>
                           <h2 className='h2 leading-tight text-accent'>my latest <br/>work
                           </h2>
                           <p className='max-w-sm mb-16'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
