...
const Banner = () => {
  return (
    <section id='home' className='min-h[85vh] lg:min-h-[78vh] flex
         items-center'>
        ...
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center
          ...
          <div className='flex-1 text-center font-secondary lg:text-left' >
            ...
            <motion.p 
              ...
              initial='hidden' whileInView={"show"}
              viewport={{ once: false, amount: 0.7 }} 
             className='mb-8 mw-w-lg mx-auto lg:mx-0 '>
              Passionate Full-Stack Developer crafting high-performance web applications
              with elegant and user-centered solutions.
            </motion.p>
            <motion.div 
